...
const repeatMyParam = () => {
    return axios.get('http://localhost:3000/repeat/my-brain-hurts')
    .then(res => 


    {const dataparam = document.getElementById('repeat-text');
    dataparam.textContent = res.data;
    dataparam.style.display = ('block')}
)}
...
// CODE HERE
const dataparam2 = () =>{
axios.get('http://localhost:3000/query-test?phrase=my-brain-hurts')
.then(res => console.log(res.data))}
document.getElementById('query-button').addEventListener('click',dataparam2)
